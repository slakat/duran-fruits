...
<head>
	...
	<link href="https://fonts.googleapis.com/css?family=Amatic+SC|Open+Sans+Condensed:300|Roboto" rel="stylesheet">
...
if ( is_front_page()  ){?>
<div id="cover-image" style="<?php echo $style ?>"></div>
<?php } 
else {
		$final = '';
		if (have_posts()) {
    ...
    $thumbnail_url = $thumbnail_data[0];
                	...
                	$final = get_bloginfo('template_directory')."/layout/images/bg.jpg";
                }


	?>
<div id="catalogue-cover" style="background: url(<?php echo $final ?>);    background-size: cover;
    background-position-y: -350px; z-index: -1;"></div>
<?php };?>
