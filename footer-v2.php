	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<span><i class="fa fa-map-marker" aria-hidden="true"></i> &nbsp; <?php the_field('footer_address','option') ?></span><br>
				<span><i class="fa fa-phone" aria-hidden="true"></i> &nbsp; <?php the_field('footer_phone','option') ?> </span><br>
				<p><i class="fa fa-envelope-o" aria-hidden="true"></i> &nbsp; <?php the_field('footer_email','option') ?></p>
			</div>
			<div class="col-sm-8">
			...
			<div class="col-sm-3">
				...
				<?php endif; ?>
				<p class="copyright">
					<span data-customizer="copyright-credit"><?php echo illdy_sanitize_html( $footer_copyright ); ?></span>
				</p>
...
<div id="post-footer"><p><?php the_field('footer_copyright','option') ?>.</p></div>
<?php wp_footer(); ?>
</body>
</html>